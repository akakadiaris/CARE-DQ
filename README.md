...
- Columns: ICD-9/10 & SNOMED diagnosis codes, treatment procedures, and medications  
- Purpose: Provides full details of cohort definitions used in the CARE-DQ EHR data quality framework study

**File:** `CARE-DQ_SupplementaryTable1.csv` – structured for easy download and analysis.
